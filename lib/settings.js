...
const defaultSettings = {
  ...
  directories: {
    ...
    uploadDir: path.join(os.tmpdir(), 'ftp-uploads'),
...
const settings = {
  ...
  get uploadDir() {
    return (
      _settings?.directories?.uploadDir || defaultSettings.directories.uploadDir
    )
  },
  get logDir() {
    return _settings?.directories?.logDir || defaultSettings.directories.logDir
  },
