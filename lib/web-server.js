...
// Short-lived bearer tokens issued by POST /api/upload/token.
// They avoid running bcrypt on every individual file upload.

const uploadTokens = new Map() // token -> { username, expiresAt }
